...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
    ...
    @method('PUT')
         ...
         <div class="form-group">
            ...
            <input type="text" class="form-control" id="stu_id" name="stu_id" value="{{ $course->id }}" readonly>
        </div>

        <div class="form-group">
            <label>Enter Instructor ID</label><small class="text-danger">
                @error('ins_id')
                {{ $message }}
                @enderror
            </small>
            <input type="text" class="form-control @error('ins_id') is-invalid @enderror" name="ins_id" value="{{ old('ins_id',$course->Ins_id) }}">
        </div>    
